        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    (0, helperFunctions_1.print)("Reciter: ".concat(reciterName, ", Surah: ").concat(data_1.surasDictionary[surahIndex]), "green");
                ...
                case 4:
                    err_3 = _b.sent();
                    if (data_1.surasDictionary[surahIndex] === undefined) {
